...
public abstract class WorkManager {
     ...
     */
    public static @NonNull
    WorkManager getInstance(@NonNull Context context) {
    ...
    Operation cancelWorkById(@NonNull UUID id);
     ...
     */
    public abstract @NonNull
    Operation cancelAllWorkByTag(@NonNull String tag);
     ...
     */
    public abstract @NonNull
    Operation cancelUniqueWork(@NonNull String uniqueWorkName);
     ...
     */
    public abstract @NonNull
    LiveData<Long> getLastCancelAllTimeMillisLiveData();
     ...
     */
    public abstract @NonNull
    LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(
            @NonNull String tag);
     ...
     */
    public abstract @NonNull
    LiveData<List<WorkInfo>> getWorkInfosForUniqueWorkLiveData(
            @NonNull String uniqueWorkName);
